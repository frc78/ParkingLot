...
public class Auto2BallHighC extends SequentialCommandGroup {
  ...
  // Chassis chassis;
  Timer timer;
  public Auto2BallHighC(Chassis chassis, Intake intake, Indexer index, Feed feed, FeedWheel feedWheel, Shooter shooter, double distance, double distance2, double spinUpVel, double degrees, boolean isHood) {
    ...
    addCommands(
      ...
      new SpinAndFire(shooter, feed, index, feedWheel, intake, Constants.spinupVel, Constants.backSpinVel, false)
    );
    }
    // @Override
