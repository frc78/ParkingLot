...
public class Tank extends CommandBase {
  ...
  public void execute() {
    ...
    double lSpeed = triggerAdjustedSpeed(m_controller.getLeftY(), 0.35, 0.15);
    double rSpeed = triggerAdjustedSpeed(m_controller.getRightY(), 0.35, 0.15);
  ...
  /**
   * 
   * @param inputSpeed The input speed from the driver's controls
   * @param upAdjust The % of speed it can increase upward
   * @param downAdjust The % of speed it can decrease downward
   * @return
   */
