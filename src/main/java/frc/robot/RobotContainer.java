...
public class RobotContainer {
  ...
  public RobotContainer() {
    ...
    autoList.addOption("4 Ball Auto High", new Auto4Ball(m_chassis, m_intake, m_indexer, m_feed, m_feedWheel, m_shooter, 1.6, 1.5, 5, 4.4, Constants.spinupVel2, -150, 124, -163, true));
